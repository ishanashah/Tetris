...
public interface Board {
     ...
     * or go out of the bounds of the board, an {@link IllegalArgumentException} will be thrown.
     */
    ...
    /**
     * Returns the number of rows cleared by the last action; returns 0 if no rows
     * were cleared.
     */
    int getRowsCleared();
     ...
     * For an empty board this is 0. This will not take the current piece into consideration.
     */
    int getMaxHeight();
     ...
     * block + 1.  The height is 0 if the column contains no blocks; this will
     * not take the current piece into consideration.
     */
    int getColumnHeight(int x);

    /**
     * Returns the number of filled blocks in the given row; this will not take
     ...
     * bounds, return null.
     *
     * This method will not take the current piece into consideration
     *
     * Note that, in the board coordinate system, (0, 0) is the lower left hand corner
